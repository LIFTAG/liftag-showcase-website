        ...
        <div className="scroll-content">
          <section className="scene-section" data-scene="0">
            <div className="scene-text" id="text0">
              ...
              <p className="scene-desc">Every machine in your gym has a LifTag QR code. One scan and you're tracking — no
          ...
          <div className="owners-dash-col">
            <div className="dash-mockup">
              <div className="dash-topbar">
                ...
                <span className="dash-topbar-title">LIFTAG DASHBOARD</span>
              </div>
