...
useLiftagStructuredData(() => [
  liftagOrganization,
  liftagWebSite,
  liftagWebPage({ path: ONE_RM_PATH, name: t('tools.calculator.title'), description: t('tools.calculator.seoDescription'), image: ogImage.value }),
  liftagBreadcrumbs([{ name: 'LIFTAG', path: '/' }, { name: t('tools.calculator.breadcrumb'), path: ONE_RM_PATH }]),
  {
    '@type': 'WebApplication',
