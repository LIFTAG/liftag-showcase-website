...
export const STATIC_PAGES: StaticPageEntry[] = [
  ...
  { path: '/journal', lastmod: '2026-09-21', changefreq: 'weekly', priority: '0.7' },
  { path: '/tools/1rm-calculator', lastmod: '2026-09-21', changefreq: 'monthly', priority: '0.8' },
  { path: '/journal/fitbod-1rm-formula', lastmod: '2026-09-21', changefreq: 'monthly', priority: '0.7' },
  ...
  { path: '/journal/what-is-rpe-lifting', lastmod: '2026-09-21', changefreq: 'monthly', priority: '0.7' },
  { path: '/journal/progressive-overload', lastmod: '2026-09-21', changefreq: 'monthly', priority: '0.7' },
